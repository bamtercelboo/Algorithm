...
public class KMP_update03
{
  ...
  public static void main( String[] args ) throws Exception
  {
    ...
    //String srcc = "aaaaaa";
    KMP_update03 kmp = new KMP_update03();
    ...
    //数组排序
    kmp.bubbleSort(suffix, suffix.length);
    for ( int i = 0; i < suffix.length; i++ ) {
      System.out.print(suffix[i] + " ");
    }
    System.out.println();

    kmp.KMPPattern(suffix, len);
  }

  //查找字符串中最长的重复的公共子串及其下标位置
  public void KMPPattern( String[] suffix, int len ) throws Exception
  {
    try {
