...
public class KMP_update04
{
  ...
  public static void main( String[] args )
  {
    ...
    KMP_update04 kmp = new KMP_update04();
   ...
   * @return
   */
  public int getNext( char[] src, int startindex )
  {
    ...
    while ( index < len ) {
      if ( k != -1 ) {
        System.out.println("str[ " + index + " ] == str[ " + k + " ] " + str[index] + "  " + str[k]);
      }
